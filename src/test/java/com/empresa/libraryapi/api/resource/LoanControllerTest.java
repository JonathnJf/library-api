...
import com.empresa.libraryapi.api.LoanController;
import com.empresa.libraryapi.api.dto.LoanDTO;
import com.empresa.libraryapi.api.dto.LoanFilterDTO;
import com.empresa.libraryapi.api.dto.ReturndedLoanDTO;
...
import com.empresa.libraryapi.service.LoanServiceTest;
...
public class LoanControllerTest {
    ...
    public void  createLoanTest() throws  Exception {
        LoanDTO dto = LoanDTO.builder().isbn("123").email("jonathan@email.com").customer("Jonathan").build();
    ...
    public void returnBookTest() throws Exception {
        ReturndedLoanDTO dto = ReturndedLoanDTO.builder().returned(true).build();
    ...
    public void findLonTest() throws Exception {
        Long id = 1l;
